global process_block_simd_stitch
...
%macro calcular_W 4
	...
	paddd xmm9, xmm5; xmm9 = W[t+3], W[t+4], ?, ? ;esto podria ir antes de (por xmm6, xmm8 ; xmm6 = ROTR(x, 17))
	...
	por %1, xmm9 ; se une el resultado en %1
